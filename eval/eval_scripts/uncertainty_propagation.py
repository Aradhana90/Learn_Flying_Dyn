...
if __name__ == "__main__":
    model = joblib.load('../cross_valid_models_disc/obj_0/kernel_1/F_10/3/model.sav')
    traj1 = joblib.load('../cross_valid_models_disc/obj_0/kernel_1/F_10/3/train_traj1.sav')
    print(traj1)
